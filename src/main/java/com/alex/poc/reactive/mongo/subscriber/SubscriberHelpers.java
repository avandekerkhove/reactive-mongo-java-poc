package com.alex.poc.reactive.mongo.subscriber;
...
/**
 * Adapted from https://github.com/mongodb/mongo-java-driver-reactivestreams/blob/master/examples/tour/src/main/tour/SubscriberHelpers.java
 *
 */
